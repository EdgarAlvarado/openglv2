...
int main()
{
	...
	Shader depthShader = Shader("res/shaders/depthMap.vs", "res/shaders/depthMap.fs", "res/shaders/depthMap.gs");
	//shader
	//reflectShader
	//modelShader
	//normalShader
	...
	*/
	...
	//Shadow matrices configuration
	float farPlane = 25.0f;
	glm::mat4 shadowProj = glm::perspective(glm::radians(90.0f), (float)SHADOW_WIDTH / (float)SHADOW_HEIGHT, 1.0f, farPlane);
